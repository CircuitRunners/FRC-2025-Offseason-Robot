...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        CommandScheduler.getInstance().schedule(RobotConstants.mAutoFactory.newRoutine("warm").trajectory("leftIntakeToShoot").cmd().withTimeout(0.5).withName("Custom Choreo Warmup Command")
        .finallyDo(drive::stopAtCurrentModuleAngles)
